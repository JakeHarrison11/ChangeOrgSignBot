...
When the script is launched the console will prompt you for a change.org link, after the link is inputted a web browser window will open. After that script should do the rest of the work.
